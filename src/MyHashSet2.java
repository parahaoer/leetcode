...
//                s[h] = 0;
    ...
    public void test(MyHashSet2 myHashSet) {
        myHashSet.remove(1);
        myHashSet.add(9);
        myHashSet.remove(24);
        myHashSet.add(53);
    ...
    public void test2(MyHashSet2 myHashSet) {
        myHashSet.remove(1);
        myHashSet.add(9);
        myHashSet.remove(24);
        myHashSet.add(53);
    ...
    public void test3(MyHashSet2 myHashSet) {
        myHashSet.contains(72);
        myHashSet.remove(91);
        myHashSet.add(48);
        myHashSet.add(41);
    ...
    public void test4(MyHashSet2 myHashSet) {
        myHashSet.remove(1);
        myHashSet.add(9);
        myHashSet.remove(24);
        myHashSet.add(53);
